...
public class CheckEventController {
    ...
    public ApiResponse<IPage<QueryResultCheckRecord>> list(
        ...
        IPage<QueryResultCheckRecord> result = originalAlarmServiceImpl.selectWithOriginaleField(alarmId, startDate, endDate, deviceName, roadId, directionDes, eventType, dealFlag, checkFlag, disposalAdvice, adviceReason, deviceId, pageNo, pageSize);
    ...
    public void insert(@RequestBody String responseText) {
        ...
        long tblId = Long.valueOf(imageId.split("_")[3]);//告警记录唯一id
