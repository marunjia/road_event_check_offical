...
import com.yuce.entity.ExtractPointRecord;
...
@Service
@Slf4j
public class VehicleAlgorithmServiceImpl implements AlgorithmService {
     ...
     * @return boolean
     */
    public boolean vehicleDeal(OriginalAlarmRecord originalAlarmRecord) {
        String alarmId = originalAlarmRecord.getId();
        log.info("停驶算法检验:{}", alarmId);
