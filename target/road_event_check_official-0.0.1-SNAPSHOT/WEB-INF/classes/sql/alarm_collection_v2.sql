CREATE TABLE `alarm_collection_v2` (
   ...
   `related_tbl_id_list` text COMMENT '关联告警id列表',
   `related_alarm_id_list` text COMMENT '关联告警id列表',
   ...
   `person_check_flag` int(11) DEFAULT '1' COMMENT '0-错误、1-正确',
   `person_check_reason` varchar(256) DEFAULT '1' COMMENT '人工检测原因打标',
   `related_source_type` int(11) DEFAULT NULL COMMENT '告警集数据来源类型：0-未知，1-非摩托车，2-摩托车',
...
) ENGINE=InnoDB AUTO_INCREMENT=684396 DEFAULT CHARSET=utf8mb4 COMMENT='核检告警集'